    ...
    <div className="Scene">
      ...
      <article className="card">
        ...
        <AppearingText className="mt-2">
          ...
          <br />
          Response is in <a href="https://github.com/dherault/dherault.com/blob/master/src/components/KoshSnowflake/handleCanvas.js#L147" target="_blank" rel="noopener noreferrer">the code</a>.
        </AppearingText>
